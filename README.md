...
**Frontend / Mobile:** ![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat&logo=nextdotjs&logoColor=white)
![React Native](https://img.shields.io/badge/React%20Native-20232A?style=flat&logo=react&logoColor=61DAFB)
![TailwindCSS](https://img.shields.io/badge/TailwindCSS-06B6D4?style=flat&logo=tailwindcss&logoColor=white)

**Infra / Tools:** ![Vercel](https://img.shields.io/badge/Vercel-000000?style=flat&logo=vercel&logoColor=white)
...
### <img src="https://api.iconify.design/pixelarticons:robot.svg?color=%23a78bfa&height=18" width="16" height="16"/> [**ShukHood**](https://github.com/shuknuk/shukhood)
**→ Creator** · Solo
A personal agent orchestration / MCP skills server unifying Claude Code, Codex, and other agents under a shared context layer, with ~800 skill files across 14 categories.
Built with `MCP`, `Python`, agent routing via `Groq/Llama`

---

### <img src="https://api.iconify.design/pixelarticons:notebook.svg?color=%23f472b6&height=18" width="16" height="16"/> [**CultureSense**](https://github.com/shuknuk/culturesense) *(Kaggle MedGemma Impact Challenge)*
**→ Co-developer** with Amit Goel
A longitudinal clinical hypothesis engine for urine/stool culture lab reports using MedGemma 4b-it — detects resistance evolution across sequential reports and outputs both clinician and patient views.

---

### <img src="https://api.iconify.design/pixelarticons:shopping-bag.svg?color=%23fb923c&height=18" width="16" height="16"/> RU Thrift *(RUMAD Incubator)*
**→ Frontend Mentee**, with collaborator jjjk45
A Rutgers-only student-to-student thrifting marketplace: no shipping, no delivery fees, peer-to-peer campus commerce.
Built with `Expo`, `React Native`, `TypeScript`, `Supabase`, `Express.js`
